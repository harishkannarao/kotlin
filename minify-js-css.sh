...
find . -name 'compiler-*.tar.gz' -type f | xargs rm
find . -name 'closure-compiler.jar' -type f | xargs rm
find . -name 'closure-compiler-*' -type d | xargs rm -rf
...
find ktor/src -name '*.min.js' | xargs rm
